...
export class $npmConfigName1666977447048 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`book\` ADD UNIQUE INDEX \`IDX_6aab7ef9cece55b895b74518d5\` (\`image_path\`)`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`book\` DROP INDEX \`IDX_6aab7ef9cece55b895b74518d5\``);
